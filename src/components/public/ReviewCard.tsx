    ...
    <div className="bg-white rounded-2xl border border-black/5 p-5">
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-full bg-gradient-to-br from-[#2563eb] to-[#2A2522] flex items-center justify-center text-white font-bold text-sm shrink-0">
          ...
          {[
            ...
            <div key={r.label} className="flex items-center gap-2 text-xs">
              ...
              <div className="flex-1 h-1.5 bg-black/8 rounded-full overflow-hidden">
                <div className="h-full bg-[#2563eb] rounded-full" style={{ width: `${((r.v || 0)/5)*100}%` }} />
              </div>
      ...
      {/* Hotel reply */}
      {review.reply_text && (
        <div className="mt-3 pl-3 border-l-2 border-[#2563eb]/40 bg-[#FAF7F2] rounded-r-lg p-3">
          <p className="text-2xs font-semibold text-[#2563eb] mb-1">ตอบกลับจากโรงแรม</p>
