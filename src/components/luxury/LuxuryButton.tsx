...
export const LuxuryButton = forwardRef<HTMLButtonElement, Props>(({
  ...
  const base = 'relative inline-flex items-center justify-center gap-2 font-semibold rounded-full transition-all duration-300 overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563eb] focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed select-none';
  ...
  const variants = {
    primary:   `bg-[#2563eb] text-white hover:bg-[#A4522A] active:scale-[0.98] shadow-lg shadow-[#2563eb]/20 ${shimmer}`,
    ...
    outline:   `bg-transparent border-2 border-[#2A2522]/20 text-[#2A2522] hover:border-[#2563eb] hover:text-[#2563eb] active:scale-[0.98]`,
  };
