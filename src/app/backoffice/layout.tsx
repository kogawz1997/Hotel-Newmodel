      ...
      <div className="hidden lg:block relative bg-secondary overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-between p-12">
          ...
          <div className="space-y-6 max-w-md">
            <p className="text-xs uppercase tracking-widest text-accent">Staff Portal</p>
            <blockquote className="font-display text-3xl xl:text-4xl font-medium leading-tight tracking-tight text-pretty">
              "ระบบงานพนักงาน — เช็คอิน แม่บ้าน ซ่อมบำรุง ทุกอย่างในที่เดียว"
            </blockquote>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-sm">Staff Access</div>
                <div className="text-xs text-muted-foreground">ใช้ลิงก์ที่ได้รับจากเจ้าของโรงแรม</div>
              </div>
            </div>
          </div>
          <div className="text-xs text-muted-foreground">
            เข้าถึงได้เฉพาะพนักงานที่ได้รับอนุญาตเท่านั้น
          </div>
        </div>
      </div>
    </div>
