  ...
  return (
    <main className="min-h-screen bg-[#FAF7F2] flex items-center justify-center px-4">
      <div className="max-w-md w-full rounded-2xl border border-black/10 bg-white p-6 text-center">
        <p className="text-xs tracking-wide text-[#2563eb] font-semibold">SEARCH ERROR</p>
        ...
        <div className="mt-5 flex gap-2 justify-center">
          <button onClick={reset} className="px-4 py-2 rounded-lg bg-[#2563eb] text-white text-sm">ลองใหม่</button>
