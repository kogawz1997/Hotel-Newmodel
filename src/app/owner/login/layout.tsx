      ...
      <div className="hidden lg:block relative bg-secondary overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-between p-12">
          ...
          <div className="space-y-6 max-w-md">
            <p className="text-xs uppercase tracking-widest text-accent">Hotel Owner Portal</p>
            <blockquote className="font-display text-3xl xl:text-4xl font-medium leading-tight tracking-tight text-pretty">
              "จัดการโรงแรมทุกด้านจากที่เดียว — รายรับ ทีมงาน และรีวิวผู้เข้าพัก"
            </blockquote>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-sm">Owner Dashboard</div>
                <div className="text-xs text-muted-foreground">สำหรับเจ้าของโรงแรมและผู้จัดการทั่วไป</div>
              </div>
            </div>
          </div>
